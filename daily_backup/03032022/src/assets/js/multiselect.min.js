        ...
        return e.prototype = {
            init: function() {
                ...
                e.undoStack = [], e.redoStack = [], e.options.keepRenderingSort && (e.skipInitSort = !0, !1 !== e.callbacks.sort && (e.callbacks.sort = {
                    ...
                    t(o).attachIndex()
                })), "function" == typeof e.callbacks.startUp && e.callbacks.startUp(e.$left, e.$right), e.skipInitSort || ("function" == typeof e.callbacks.sort.left && e.$left.mSort(e.callbacks.sort.left), "function" == typeof e.callbacks.sort.right && e.$right.each(function(_o, n) {
    ...
    t.multiselect = {
        defaults: {
            startUp: function(e, o) {
                o.find("option").each(function(_o, n) {
            ...
            beforeMoveToRight: function(t, e) {
                return !0
            },
            ...
            afterMoveToLeft: function(t, _e, o) {},

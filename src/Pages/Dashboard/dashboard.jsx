                ...
                <div className="card-body">
                  ...
                  <div className="leave-info-box">
                    <div className="media align-items-center">
                      <Link to = "/app/profile/employee-profile" className="avatar"><img alt="" src="" /></Link>
                    ...
                    <table className="table custom-table mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="#" className="avatar"><img alt="" src="" /></a>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <Link to = "/app/profile/client-profile" className="avatar"><img alt="" src="" /></Link>
